...
struct HamburgerMenu: View {
    ...
    // Opciones del menú
    let menuOptions = ["Cargar Funcionarios", "Menú", "Cerrar Sesión", "Ayuda"]
    ...
    private func handleMenuSelection(_ option: String) {
        switch option {
        case "Cargar Funcionarios":
            activeView = .employeesAdd
        case "Menú":
            selectedTab = nil
            activeView = nil
        case "Cerrar Sesión":
    ...
    private func iconForOption(_ option: String) -> String {
        switch option {
        case "Cargar Funcionarios": return "person.3.fill"
